...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2020 at 07:24 PM
...
--
-- Dumping data for table `jadwal_available`
--
...
(1, NULL, 1, 'file_cv_1.pdf', 'video_microteaching_1.mp4', NULL, 16, 3.37),
...
(6, NULL, 6, 'file_cv_6.pdf', 'video_microteaching_6.mp4', NULL, 28, 3.45),
(7, NULL, 8, 'file_cv_8.pdf', 'video_microteaching_8.mp4', NULL, 72, 3.60),
(8, NULL, 7, 'file_cv_7.pdf', 'video_microteaching_7.mp4', NULL, 18, 3.30),
(9, NULL, 9, 'file_cv_9.pdf', 'video_microteaching_9.mp4', NULL, 4, 3.53),
...
(13, NULL, 15, 'file_cv_15.pdf', 'video_microteaching_15.mp4', NULL, 24, 4.00);
...
(15, NULL, NULL, NULL, 'Abdul Khalid', 'pilotrouge@gmail.com', 'laki-laki', '1998-04-10', '0878454315', NULL, 'Universitas Surabaya', NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `alamat`
  MODIFY `id_alamat` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `guru_mapel`
  MODIFY `id_guru_mapel` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `pendaftaran_guru`
  MODIFY `id_pendaftaran` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
